...
class MacPackager extends (_platformPackager || _load_platformPackager()).PlatformPackager {
    ...
    sign(appOutDir, masOptions) {
        ...
        return (0, (_bluebirdLstC || _load_bluebirdLstC()).coroutine)(function* () {
            ...
            let name = yield (0, (_codeSign || _load_codeSign()).findIdentity)(isMas ? "3rd Party Mac Developer Application" : "Developer ID Application", isMas ? masQualifier : qualifier, keychainName);
            if (name == null) {
                if (!isMas) {
            ...
            const signOptions = {
                identity: name,
                type: masOptions == null ? _this3.platformSpecificBuildOptions.type : masOptions.type,
