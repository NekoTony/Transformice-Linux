...
class HttpExecutor {
    ...
    request(options, data) {
        ...
        return this.doApiRequest(options, it => it.end(encodedData), 0);
    }
    handleResponse(response, options, resolve, reject, redirectCount, requestProcessor) {
    ...
    `));
        ...
        if (redirectUrl != null) {
            ...
            this.doApiRequest(Object.assign({}, options, (0, (_url || _load_url()).parse)(redirectUrl)), requestProcessor, redirectCount).then(resolve).catch(reject);
            return;
        }
        let data = "";
