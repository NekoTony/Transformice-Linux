...
function bintrayRequest(path, auth) {
    ...
    return (0, (_httpExecutor || _load_httpExecutor()).request)((0, (_httpExecutor || _load_httpExecutor()).configureRequestOptions)({ hostname: "api.bintray.com", path: path }, auth, method), data);
}
class BintrayClient {
